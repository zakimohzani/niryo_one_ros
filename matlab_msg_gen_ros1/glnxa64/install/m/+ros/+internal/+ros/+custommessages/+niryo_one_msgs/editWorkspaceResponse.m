function [data, info] = editWorkspaceResponse
%EditWorkspace gives an empty data for niryo_one_msgs/EditWorkspaceResponse
...
info.MessageType = 'niryo_one_msgs/EditWorkspaceResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
