function [data, info] = managePositionRequest
%ManagePosition gives an empty data for niryo_one_msgs/ManagePositionRequest
% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
[data.cmd_type, info.cmd_type] = ros.internal.ros.messages.ros.default_type('int32',1);
[data.position_name, info.position_name] = ros.internal.ros.messages.ros.char('string',0);
[data.position, info.position] = ros.internal.ros.custommessages.niryo_one_msgs.position;
info.position.MLdataType = 'struct';
info.MessageType = 'niryo_one_msgs/ManagePositionRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
