function [data, info] = robotMoveResponse
%RobotMove gives an empty data for niryo_one_msgs/RobotMoveResponse
...
info.MessageType = 'niryo_one_msgs/RobotMoveResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
