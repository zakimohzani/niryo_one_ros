function [data, info] = matlabMoveResult
%MatlabMoveResult gives an empty data for niryo_one_msgs/MatlabMoveResult
...
info.MessageType = 'niryo_one_msgs/MatlabMoveResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
