function [data, info] = setConveyorResponse
%SetConveyor gives an empty data for niryo_one_msgs/SetConveyorResponse
...
info.MessageType = 'niryo_one_msgs/SetConveyorResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
