function [data, info] = manageProcessResponse
%ManageProcess gives an empty data for niryo_one_msgs/ManageProcessResponse
...
info.MessageType = 'niryo_one_msgs/ManageProcessResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
