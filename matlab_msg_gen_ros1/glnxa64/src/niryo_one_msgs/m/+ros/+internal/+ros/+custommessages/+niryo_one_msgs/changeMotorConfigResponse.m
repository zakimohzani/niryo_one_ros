function [data, info] = changeMotorConfigResponse
%ChangeMotorConfig gives an empty data for niryo_one_msgs/ChangeMotorConfigResponse
...
info.MessageType = 'niryo_one_msgs/ChangeMotorConfigResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
