function [data, info] = updateConveyorIdResponse
%UpdateConveyorId gives an empty data for niryo_one_msgs/UpdateConveyorIdResponse
...
info.MessageType = 'niryo_one_msgs/UpdateConveyorIdResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
