...
// Service Client for niryo_one_msgs/generatetrajRequest
...
NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::generatetraj::Request& request,
...
NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const niryo_one_msgs::generatetraj::Response& response);
} // namespace generatetraj_Response
} // namespace matlabhelper
} // namespace niryo_one_msgs
class NIRYO_ONE_MSGS_EXPORT niryo_one_msgs_srv_generatetraj_client
    ...
    std::map<int64_t, niryo_one_msgs::generatetraj::Request> mRequestPool;
    niryo_one_msgs::generatetraj::Request mNextRequest;
  public:
    niryo_one_msgs_srv_generatetraj_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~niryo_one_msgs_srv_generatetraj_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<niryo_one_msgs::generatetraj>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        niryo_one_msgs::generatetraj svc;
        ...
        if (ret) {
            ...
            auto outArray =
                niryo_one_msgs::matlabhelper::generatetraj_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        niryo_one_msgs::generatetraj::Request req;
        niryo_one_msgs::matlabhelper::generatetraj_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {niryo_one_msgs::matlabhelper::generatetraj_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(niryo_one_msgs_srv_generatetraj_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
