...
// Service Server for niryo_one_msgs/GetTargetPoseResponse
...
NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const niryo_one_msgs::GetTargetPose::Request& request);
} // namespace GetTargetPose_Request
} // namespace matlabhelper
} // namespace niryo_one_msgs
namespace niryo_one_msgs {
...
NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::GetTargetPose::Response& response,
                                          const matlab::data::StructArray arr);
} // namespace GetTargetPose_Response
} // namespace matlabhelper
} // namespace niryo_one_msgs
class NIRYO_ONE_MSGS_EXPORT niryo_one_msgs_srv_GetTargetPose_server
    : public MATLABSvcServerInterface {
    niryo_one_msgs::GetTargetPose::Response mResponse;
    void* mSd;
    SendDataToMATLABFunc_T mSendDataToMATLABFunc;
    intptr_t mHSvcServer;
    bool callback(niryo_one_msgs::GetTargetPose::Request& req,
                  niryo_one_msgs::GetTargetPose::Response& res) {
        auto outArray = niryo_one_msgs::matlabhelper::GetTargetPose_Request::get_arr(mFactory, req);
        if (mSd != NULL) {
  ...
  public:
    niryo_one_msgs_srv_GetTargetPose_server()
    ...
    virtual ~niryo_one_msgs_srv_GetTargetPose_server() {
    }
    virtual bool setResponseFromMatlab(matlab::data::Array arr) {
        niryo_one_msgs::matlabhelper::GetTargetPose_Response::copy_from_arr(mResponse, arr);
        return true;
    }
    virtual intptr_t createSvcServer(const std::string& svc_name,
        ...
        mSvc = std::make_shared<ros::ServiceServer>(theNode->advertiseService(
            svc_name, &niryo_one_msgs_srv_GetTargetPose_server::callback, this));
...
CLASS_LOADER_REGISTER_CLASS(niryo_one_msgs_srv_GetTargetPose_server, MATLABSvcServerInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
