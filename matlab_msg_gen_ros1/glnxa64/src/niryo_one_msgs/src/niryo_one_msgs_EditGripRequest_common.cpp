...
namespace EditGripRequest {
  ...
  MDArray_T get_arr_niryo_one_msgs_RobotState(MDFactory_T& factory, const niryo_one_msgs::EditGripRequest::_robot_pose_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::EditGripRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //cmd
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::EditGripRequest>& msg) {
