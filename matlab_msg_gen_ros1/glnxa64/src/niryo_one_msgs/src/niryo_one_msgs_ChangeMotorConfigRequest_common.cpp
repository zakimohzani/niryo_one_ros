...
namespace ChangeMotorConfigRequest {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::ChangeMotorConfigRequest>& msg, const matlab::data::StructArray arr) {
    try {
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::ChangeMotorConfigRequest>& msg) {
    auto outArray = factory.createStructArray({1,1},{"can_required_motor_id_list","dxl_required_motor_id_list"});
    // can_required_motor_id_list
    outArray[0]["can_required_motor_id_list"] = factory.createArray<niryo_one_msgs::ChangeMotorConfigRequest::_can_required_motor_id_list_type::const_iterator, int32_t>({1, msg->can_required_motor_id_list.size()}, msg->can_required_motor_id_list.begin(), msg->can_required_motor_id_list.end());
    // dxl_required_motor_id_list
    outArray[0]["dxl_required_motor_id_list"] = factory.createArray<niryo_one_msgs::ChangeMotorConfigRequest::_dxl_required_motor_id_list_type::const_iterator, int32_t>({1, msg->dxl_required_motor_id_list.size()}, msg->dxl_required_motor_id_list.begin(), msg->dxl_required_motor_id_list.end());
