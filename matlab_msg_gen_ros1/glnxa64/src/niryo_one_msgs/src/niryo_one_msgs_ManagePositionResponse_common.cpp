...
// Common copy functions for niryo_one_msgs/ManagePositionResponse
...
namespace ManagePositionResponse {
  ...
  MDArray_T get_arr_niryo_one_msgs_Position(MDFactory_T& factory, const niryo_one_msgs::ManagePositionResponse::_position_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::ManagePositionResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //status
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::ManagePositionResponse>& msg) {
    auto outArray = factory.createStructArray({1,1},{"status","message","position"});
    // status
