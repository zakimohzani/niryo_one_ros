...
namespace DebugColorDetectionRequest {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::DebugColorDetectionRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //color
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::DebugColorDetectionRequest>& msg) {
