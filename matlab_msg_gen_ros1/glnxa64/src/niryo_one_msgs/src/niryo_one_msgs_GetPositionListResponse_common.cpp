...
// Common copy functions for niryo_one_msgs/GetPositionListResponse
...
namespace GetPositionListResponse {
  ...
  MDArray_T get_arr_niryo_one_msgs_Position_var_arr(MDFactory_T& factory, const niryo_one_msgs::GetPositionListResponse::_positions_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::GetPositionListResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //positions
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::GetPositionListResponse>& msg) {
