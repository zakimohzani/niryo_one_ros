...
namespace ManageSequence_Request {
  ...
  MDArray_T get_arr_niryo_one_msgs_Sequence(MDFactory_T& factory, const niryo_one_msgs::ManageSequence::Request::_sequence_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_niryo_one_msgs_Sequence(niryo_one_msgs::Sequence& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::ManageSequence::Request& msg, const matlab::data::StructArray arr) {
    try {
        //cmd_type
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::ManageSequence::Request& msg) {
