...
namespace SetSequenceAutorun_Request {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::SetSequenceAutorun::Request& msg, const matlab::data::StructArray arr) {
    try {
        //enable
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::SetSequenceAutorun::Request& msg) {
    ...
    // sequence_ids
    outArray[0]["sequence_ids"] = factory.createArray<niryo_one_msgs::SetSequenceAutorun::Request::_sequence_ids_type::const_iterator, int32_t>({1, msg.sequence_ids.size()}, msg.sequence_ids.begin(), msg.sequence_ids.end());
