...
namespace ManagePositionRequest {
  ...
  MDArray_T get_arr_niryo_one_msgs_Position(MDFactory_T& factory, const niryo_one_msgs::ManagePositionRequest::_position_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::ManagePositionRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //cmd_type
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::ManagePositionRequest>& msg) {
