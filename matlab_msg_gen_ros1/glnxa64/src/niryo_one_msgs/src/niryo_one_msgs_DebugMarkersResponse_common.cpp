...
// Common copy functions for niryo_one_msgs/DebugMarkersResponse
...
namespace DebugMarkersResponse {
  void copy_from_arr_sensor_msgs_CompressedImage(sensor_msgs::CompressedImage& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_sensor_msgs_CompressedImage(MDFactory_T& factory, const niryo_one_msgs::DebugMarkersResponse::_img_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::DebugMarkersResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //markers_detected
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::DebugMarkersResponse>& msg) {
