...
// Service Server for niryo_one_msgs/GetCalibrationCamResponse
...
NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const niryo_one_msgs::GetCalibrationCam::Request& request);
} // namespace GetCalibrationCam_Request
} // namespace matlabhelper
} // namespace niryo_one_msgs
namespace niryo_one_msgs {
...
NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::GetCalibrationCam::Response& response,
                                          const matlab::data::StructArray arr);
} // namespace GetCalibrationCam_Response
} // namespace matlabhelper
} // namespace niryo_one_msgs
class NIRYO_ONE_MSGS_EXPORT niryo_one_msgs_srv_GetCalibrationCam_server
    : public MATLABSvcServerInterface {
    niryo_one_msgs::GetCalibrationCam::Response mResponse;
    void* mSd;
    SendDataToMATLABFunc_T mSendDataToMATLABFunc;
    intptr_t mHSvcServer;
    bool callback(niryo_one_msgs::GetCalibrationCam::Request& req,
                  niryo_one_msgs::GetCalibrationCam::Response& res) {
        auto outArray = niryo_one_msgs::matlabhelper::GetCalibrationCam_Request::get_arr(mFactory, req);
        if (mSd != NULL) {
  ...
  public:
    niryo_one_msgs_srv_GetCalibrationCam_server()
    ...
    virtual ~niryo_one_msgs_srv_GetCalibrationCam_server() {
    }
    virtual bool setResponseFromMatlab(matlab::data::Array arr) {
        niryo_one_msgs::matlabhelper::GetCalibrationCam_Response::copy_from_arr(mResponse, arr);
        return true;
    }
    virtual intptr_t createSvcServer(const std::string& svc_name,
        ...
        mSvc = std::make_shared<ros::ServiceServer>(theNode->advertiseService(
            svc_name, &niryo_one_msgs_srv_GetCalibrationCam_server::callback, this));
...
CLASS_LOADER_REGISTER_CLASS(niryo_one_msgs_srv_GetCalibrationCam_server, MATLABSvcServerInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
