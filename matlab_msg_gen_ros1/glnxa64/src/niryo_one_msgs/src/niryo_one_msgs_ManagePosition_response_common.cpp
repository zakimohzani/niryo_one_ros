...
// Common copy functions of server for niryo_one_msgs/ManagePositionResponse
...
namespace ManagePosition_Response {
  ...
  MDArray_T get_arr_niryo_one_msgs_Position(MDFactory_T& factory, const niryo_one_msgs::ManagePosition::Response::_position_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::ManagePosition::Response& msg, const matlab::data::StructArray arr) {
    try {
        //status
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::ManagePosition::Response& msg) {
