...
// Common copy functions for niryo_one_msgs/ManageSequenceResponse
...
namespace ManageSequenceResponse {
  ...
  MDArray_T get_arr_niryo_one_msgs_Sequence(MDFactory_T& factory, const niryo_one_msgs::ManageSequenceResponse::_sequence_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_niryo_one_msgs_Sequence(niryo_one_msgs::Sequence& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::ManageSequenceResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //status
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::ManageSequenceResponse>& msg) {
