...
// Common copy functions of server for niryo_one_msgs/ChangeMotorConfigResponse
...
namespace ChangeMotorConfig_Response {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::ChangeMotorConfig::Response& msg, const matlab::data::StructArray arr) {
    try {
        //status
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::ChangeMotorConfig::Response& msg) {
