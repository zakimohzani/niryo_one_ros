...
// Common copy functions for niryo_one_msgs/GetWorkspaceRatioRequest
...
namespace GetWorkspaceRatio_Request {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::GetWorkspaceRatio::Request& msg, const matlab::data::StructArray arr) {
    try {
        //workspace
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::GetWorkspaceRatio::Request& msg) {
