...
namespace RobotMoveRequest {
  ...
  MDArray_T get_arr_niryo_one_msgs_RobotMoveCommand(MDFactory_T& factory, const niryo_one_msgs::RobotMoveRequest::_cmd_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::RobotMoveRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //cmd
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::RobotMoveRequest>& msg) {
