...
// Common copy functions for niryo_one_msgs/UpdateConveyorIdResponse
...
namespace UpdateConveyorIdResponse {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::UpdateConveyorIdResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //status
        const matlab::data::TypedArray<uint8_t> status_arr = arr[0]["status"];
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::UpdateConveyorIdResponse>& msg) {
