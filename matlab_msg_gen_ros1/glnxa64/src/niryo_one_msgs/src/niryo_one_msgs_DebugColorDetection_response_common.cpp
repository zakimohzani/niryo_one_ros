...
// Common copy functions of server for niryo_one_msgs/DebugColorDetectionResponse
...
namespace DebugColorDetection_Response {
  ...
  MDArray_T get_arr_sensor_msgs_CompressedImage(MDFactory_T& factory, const niryo_one_msgs::DebugColorDetection::Response::_img_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::DebugColorDetection::Response& msg, const matlab::data::StructArray arr) {
    try {
        //img
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::DebugColorDetection::Response& msg) {
