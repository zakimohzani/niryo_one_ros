...
// Service Client for niryo_one_msgs/GetPositionListRequest
...
namespace GetPositionList_Request {
NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::GetPositionList::Request& request,
...
NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const niryo_one_msgs::GetPositionList::Response& response);
} // namespace GetPositionList_Response
} // namespace matlabhelper
} // namespace niryo_one_msgs
class NIRYO_ONE_MSGS_EXPORT niryo_one_msgs_srv_GetPositionList_client
    ...
    std::map<int64_t, niryo_one_msgs::GetPositionList::Request> mRequestPool;
    niryo_one_msgs::GetPositionList::Request mNextRequest;
  public:
    niryo_one_msgs_srv_GetPositionList_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~niryo_one_msgs_srv_GetPositionList_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<niryo_one_msgs::GetPositionList>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        niryo_one_msgs::GetPositionList svc;
        ...
        if (ret) {
            ...
            auto outArray =
                niryo_one_msgs::matlabhelper::GetPositionList_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        niryo_one_msgs::GetPositionList::Request req;
        niryo_one_msgs::matlabhelper::GetPositionList_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {niryo_one_msgs::matlabhelper::GetPositionList_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(niryo_one_msgs_srv_GetPositionList_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
