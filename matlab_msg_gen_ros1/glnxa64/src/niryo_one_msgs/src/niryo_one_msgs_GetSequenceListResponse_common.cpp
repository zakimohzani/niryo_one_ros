...
// Common copy functions for niryo_one_msgs/GetSequenceListResponse
...
namespace GetSequenceListResponse {
  ...
  MDArray_T get_arr_niryo_one_msgs_Sequence_var_arr(MDFactory_T& factory, const niryo_one_msgs::GetSequenceListResponse::_sequences_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_niryo_one_msgs_Sequence_var_arr(niryo_one_msgs::Sequence& val, const matlab::data::Struct& arr) {
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::GetSequenceListResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //sequences
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::GetSequenceListResponse>& msg) {
