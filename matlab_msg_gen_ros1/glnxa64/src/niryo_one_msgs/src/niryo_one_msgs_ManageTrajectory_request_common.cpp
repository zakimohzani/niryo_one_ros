...
namespace ManageTrajectory_Request {
  ...
  MDArray_T get_arr_niryo_one_msgs_Trajectory(MDFactory_T& factory, const niryo_one_msgs::ManageTrajectory::Request::_trajectory_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::ManageTrajectory::Request& msg, const matlab::data::StructArray arr) {
    try {
        //cmd_type
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::ManageTrajectory::Request& msg) {
