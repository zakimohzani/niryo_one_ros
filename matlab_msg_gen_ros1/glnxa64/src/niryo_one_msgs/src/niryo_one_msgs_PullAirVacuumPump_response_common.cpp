...
// Common copy functions of server for niryo_one_msgs/PullAirVacuumPumpResponse
...
namespace PullAirVacuumPump_Response {
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::PullAirVacuumPump::Response& msg, const matlab::data::StructArray arr) {
    try {
        //state
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::PullAirVacuumPump::Response& msg) {
