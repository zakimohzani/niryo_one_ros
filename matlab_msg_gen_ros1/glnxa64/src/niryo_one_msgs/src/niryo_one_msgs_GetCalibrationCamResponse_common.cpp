...
// Common copy functions for niryo_one_msgs/GetCalibrationCamResponse
...
namespace GetCalibrationCamResponse {
  ...
  MDArray_T get_arr_sensor_msgs_CameraInfo(MDFactory_T& factory, const niryo_one_msgs::GetCalibrationCamResponse::_camera_info_type& val);
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<niryo_one_msgs::GetCalibrationCamResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //is_set
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const niryo_one_msgs::GetCalibrationCamResponse>& msg) {
