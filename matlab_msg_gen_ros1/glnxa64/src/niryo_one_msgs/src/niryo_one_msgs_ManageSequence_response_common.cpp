...
// Common copy functions of server for niryo_one_msgs/ManageSequenceResponse
...
namespace ManageSequence_Response {
  ...
  MDArray_T get_arr_niryo_one_msgs_Sequence(MDFactory_T& factory, const niryo_one_msgs::ManageSequence::Response::_sequence_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_niryo_one_msgs_Sequence(niryo_one_msgs::Sequence& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT void copy_from_arr(niryo_one_msgs::ManageSequence::Response& msg, const matlab::data::StructArray arr) {
    try {
        //status
  ...
  //----------------------------------------------------------------------------
  NIRYO_ONE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const niryo_one_msgs::ManageSequence::Response& msg) {
    auto outArray = factory.createStructArray({1,1},{"status","message","sequence"});
    // status
